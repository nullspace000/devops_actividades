...
### 4. Desarrollar un script en Python para automatizar tareas
   ...
   ![screenshot](docs/imgs/7.png)
   Configurar los datos en el EC2  
   ![screenshot](docs/imgs/8.png)
   ...
   ![screenshot](docs/imgs/9.png)  
   Correrlo  
   ![screenshot](docs/imgs/10.png)  
   ![screenshot](docs/imgs/11.png)
   ...
   ![screenshot](docs/imgs/5.png)
   6. Listar buckets en S3 y sus objetos.  
   ![screenshot](docs/imgs/6.png)
